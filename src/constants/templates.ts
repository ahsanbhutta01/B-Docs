export const templates = [
   ...
   { 
      ...
      initialContent: `
         ...
         <p>This is business letter tempelate.</p>
      `
   },
   { 
      id: "resume", 
      ...
      initialContent: `
         ...
         <h2>Skills</h2>
         <p>List of relevant skills and competecies.</p>
      `
   },
   { 
      id: "cover-letter", 
      ...
      initialContent: `
         <p>
            [Your Name] <br/> [Your Address] <br/> [City, State ZIP]
         </p>

         <p>[Date]</p>

         <p>
            [Recipient's Name] <br/> [Company Name] <br/> [Company Address]
         </p>
