...
const TempletesGallery = () => {
  ...
  if(isCreating) return <FullScreenLoader label="Loading..."/>

  return (
    <div className="bg-[#F1F3F4]">
      
      <section className="max-w-screen mx-auto px-14 py-6 flex flex-col gap-y-4">
          ...
          <CarouselContent className="-ml-4">
            {
              templates.map((template)=>(
                ...
                >
                  <div 
                    className={cn(
                      "aspect-[2/2] flex flex-col gap-y-2.5 ",
