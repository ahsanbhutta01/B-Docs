...
const Ruler = () => {
	...
	function handleLeftMousDown() {
		setIsDraggingLeft(true);
	}
	function handleRightMousDown() {
   ...
   function handleRightDoubleClick(){
	...
	return (
		<div
			...
			onMouseLeave={hanldeMouseUp}
			className='w-[816px] mx-auto h-6 border-b border-gray-300 flex items-end relative top-1.5 select-none prin:hidden'>
			<section
				id='ruler-container'
								...
								<div
									...
									{marker % 10 === 0 && (
										<>
											...
											<span className='absolute bottom-2 w-[10px] text-neutral-500 transform -translate-x-1/3'>
												{marker / 10 + 1}
											</span>
										</>
									)}
